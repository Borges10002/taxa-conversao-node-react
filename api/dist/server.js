...
// src/http/controllers/conversion/routes.ts
async function conversionRoutes(app2) {
...
app.register(import_swagger.default, {
  swagger: {
    ...
    info: {
      title: "Conversions",
      description: "Especifica\xE7\xF5es da API para o back-end da aplica\xE7\xE3o Desafio Tech Lead: Evolu\xE7\xE3o Temporal de taxa de convers\xE3o",
      version: "1.0.0"
    }
  },
