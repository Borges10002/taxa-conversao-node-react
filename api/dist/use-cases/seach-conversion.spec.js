...
// node_modules/@vitest/runner/node_modules/p-limit/index.js
...
var SearchConversionUseCase = class {
  constructor(conversionRepository2) {
    this.conversionRepository = conversionRepository2;
  }
...
// src/use-cases/seach-conversion.spec.ts
...
describe("Search Conversion Use Case", () => {
  ...
  it("shold be able to search for conversion", async () => {
    ...
    globalExpect(conversion).toHaveLength(3);
    globalExpect(conversion).toEqual(
      globalExpect.arrayContaining([globalExpect.objectContaining({ channel: "email" })])
    );
  });
});
...
@vitest/snapshot/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=seach-conversion.spec.js.map